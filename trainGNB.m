function [trainedClassifier, validationAccuracy] = trainGNB(trainingData)
...
% Auto-generated by MATLAB on 15-Dec-2020 16:53:04
...
predictorNames = {'age', 'workclass', 'education_level', 'educationnum', 'maritalstatus', 'occupation', 'relationship', 'race', 'sex', 'capitalgain', 'capitalloss', 'hoursperweek', 'nativecountry'};
predictors = inputTable(:, predictorNames);
response = inputTable.income_b;
isCategoricalPredictor = [false, true, true, false, true, true, true, true, true, false, false, false, true];
...
trainedClassifier.RequiredVariables = {'age', 'capitalgain', 'capitalloss', 'education_level', 'educationnum', 'hoursperweek', 'maritalstatus', 'nativecountry', 'occupation', 'race', 'relationship', 'sex', 'workclass'};
